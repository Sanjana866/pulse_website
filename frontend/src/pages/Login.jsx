...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (!email || !password) return handleError('Fill out all the fields');
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F4FAF3] px-4">
      <div
        ref={sectionRef}
        className={`bg-white p-8 rounded-lg shadow-md w-full max-w-md transition-opacity duration-1000 ${
      ...
      >
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div className="flex px-2 space-x-2 w-full py-3">
            ...
            <Link to="/register" className="text-sm font-bold text-green-700/75 underline">
              Create now
            </Link>
          </div>
        </form>
