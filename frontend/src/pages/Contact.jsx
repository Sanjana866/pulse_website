...
const Contact=()=>{
    return(
        <div className='flex flex-col items-center justify-center pt-12'>
            <h1 className='font-bold text-3xl md:text-4xl text-[#612D2D] pb-4'>CONTACT US</h1>
            <p className='text-center'>Have any questions or feedback? Your opinion is valuable to us.</p>
            <div>
